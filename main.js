function GetInfo() {
 ...
 //fetch('https://api.openweathermap.org/data/2.5/weather?q=${cityName}&units=metric&appid=5d146e729747a13d5615b0655aa430fe`)
  // fetch(`https://api.openweathermap.org/data/2.5/weather?q='+newName.value+'&appid=5d146e729747a13d5615b0655aa430fe`)32ba0bfed592484379e51106cef3f204
fetch('https://api.openweathermap.org/data/2.5/forecast?q='+newName.value+'&appid=5d146e729747a13d5615b0655aa430fe')
